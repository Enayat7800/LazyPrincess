...
DATABASE_NAME = environ.get('DATABASE_NAME', "inayatali")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001819528169))
...
#ai
# OPENAI_API = environ.get("OPENAI_API","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")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Enayatali1') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','moviesadda201') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','moviesadda201') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','webseriesworld20')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "allinoneadda0") #[ without @ ]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'LftdVbw4mxeOaY3u8dWGFzorF663')
